...
public class IOUtils {
	 ...
	 * <code>Reader</code>. Will flush the <code>OutputStream</code>, but
	 * won't close <code>Reader</code> or <code>OutputStream</code>.
	 * 
	 * @param out
	...
	/**
	 * Copies the content of an <code>OutputStream</code> to a
	 * <code>Writer</code>. Will flush the <code>OutputStream</code>, but
	 * won't close <code>Writer</code> or <code>OutputStream</code>.
	 * 
	 * @param out
	 *            <code>OutputStream</code> from which data is read.
	...
	/**
	 * Copies the content of an <code>InputStream</code> to a
	 * <code>Reader</code>. Will flush the <code>InputStream</code>, but
	 * won't close <code>Reader</code> or <code>InputStream</code>.
	 * 
	 * @param in
	 *            <code>InputStream</code> from which data is read.
