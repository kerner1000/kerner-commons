...
public class LazyFileCopier {
	...
	public LazyFileCopier(String inFilePath, String outFilePath) throws IOException {
	...
	public LazyFileCopier(File inFile, File outDir, String outFileName) throws IOException {
